...
urlpatterns = [
    ...
    path('update_equipment/<int:pk>/', views.UpdateEquipmentView.as_view(), name='update-equipment'),
    ...
    path('update_operator_emergency/<int:pk>/', views.UpdateOperatorEmergencyView.as_view(), name='update-operator-emergency'),
]